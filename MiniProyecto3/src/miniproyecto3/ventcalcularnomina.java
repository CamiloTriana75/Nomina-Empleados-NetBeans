...
public class ventcalcularnomina extends javax.swing.JFrame {

    
    public ventcalcularnomina() {
       initComponents();
    }
    ...
    private void initComponents() {
        ...
        panel1.add(fechabox);
        fechabox.setBounds(0, 610, 200, 50);

        Calcular1.setFont(new java.awt.Font("Showcard Gothic", 0, 18)); // NOI18N
        ...
        panel1.add(Calcular1);
        Calcular1.setBounds(220, 610, 130, 50);
        ...
        titulo.setText("calcular nomina");
        panel2.add(titulo);
        ...
        guardar.setFont(new java.awt.Font("Showcard Gothic", 0, 18)); // NOI18N
        ...
        panel2.add(guardar);
        guardar.setBounds(60, 40, 130, 50);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ventcalcularnomina.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new ventcalcularnomina().setVisible(true);
